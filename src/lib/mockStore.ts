...
let users: User[] = [
  { id: "1", name: "Vitalik B.", email: "vitalik@eth.org", wallet: "0x7a3b9c...d4e2", joinedAt: "2024-01-15" },
  { id: "2", name: "Satoshi N.", email: "satoshi@btc.org", wallet: "0x1f2e8b...a7c3", joinedAt: "2024-02-20" },
  { id: "3", name: "Ada L.", email: "ada@cardano.io", wallet: "0x9d4c7a...f1b8", joinedAt: "2024-03-10" },
  { id: "4", name: "Gavin W.", email: "gavin@dot.network", wallet: "0x5e8f2d...c6a9", joinedAt: "2024-03-22" },
];
...
export const mockApi = {
  ...
  uploadFile: (fileName: string) => {
    ...
    files = [file, ...files];
    activities = [{ id: String(++nextId), action: `Uploaded ${fileName}`, user: "You", time: "Just now" }, ...activities];
    return file;
  },
